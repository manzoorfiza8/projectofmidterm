    ...
    <div className="detailcard-container">
      <div className="detailcard-content">
        <div className="left-content">
          <h1 className="detailcard-heading">5 Days Tour to Skardu Valley
            {/* {card.title} */}
            </h1>
          <div className="location-container">
      <MdLocationOn size={29} className="location-icon" />
      <h3 className="detailcard-heading">Muzafarzabad Azad Kashmir/Tours</h3>
    </div>
          <p className="detailcard-text">
          Explore the rich history of Muzaffarabad, with its ancient forts and vibrant local markets, providing a glimpse into the region's cultural heritage.
          </p>
          <p className='chip'>starting From Rs.13000 per person</p>
          ...
          <div className="button-container">
            <button className="detailcard-button">Add to Cart</button>
            <button className="detailcard-button">Reserve Now</button>
          </div>
